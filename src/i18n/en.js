    ...
    resources: [
        {
            ...
            items: [
                {
                    text: 'Douglas B. West. <em>Grammar according to West</em>',
                    url: 'https://faculty.math.illinois.edu/~west/grammar.html',
                },
                {
                    text: 'Paul R. Halmos. <em>How to write mathematics</em>',
                    url: 'https://www.amazon.com/How-Write-Mathematics-Norman-Steenrod/dp/0821800558',
                },
            ],
        },
        {
            ...
            items: [
                ...
                {
                    text: 'Writing in proper high-level \\(\\LaTeX\\): <em>l2tabu</em>',
                    url: 'https://www.ctan.org/pkg/l2tabu-english',
                },
                {
                    text: 'Notes on advanced math typesetting: Wikibooks: LaTeX/Advanced Mathematics',
                    url: 'https://en.wikibooks.org/wiki/LaTeX/Advanced_Mathematics',
                },
                {
                    text: '\\(\\LaTeX\\) Tutorial for Beginners on YouTube',
                    url: 'https://www.youtube.com/watch?v=fCzF5gDy60g',
                },
                {
                    text: 'Interactive MathJax/KaTeX based \\(\\LaTeX\\) primer: www.ilatexprimer.com',
                    url: 'https://www.dainiak.com/ilatexprimer/',
                },
                {
                    text: '\\(\\LaTeX\\) symbol lookup: <a href="https://detexify.kirelabs.org/classify.html" target="_blank">Detexify</a> and <a href="http://www.martin-thoma.de/write-math/classify/" target="_blank">Write Math</a>',
                    url: null,
                },
            ],
        },
        {
            ...
            items: [
                ...
                {
                    text: '<em>Textidote</em> correction tool for \\(\\LaTeX\\) documents',
        ...
        },
        {
            ...
            items: [
                {
                    text: 'Quick \\(\\LaTeX\\) in-browser preview: LaTeX.js',
                    url: 'https://latex.js.org/playground.html',
                },
            ],
        },
    ],
