...
function initiate() {
    ...
    function checkLatexCode(latexString, addWarningCustom) {
        ...
        let errors = this.errors = {
            "DOUBLE_DOLLARS": {
                "msg": "Двойных долларов в тексте быть не должно. Выносные формулы нужно оформлять с помощью <code>\\[</code>…<code>\\]</code>. Объяснение см. по <a href=\"https://tex.stackexchange.com/questions/503/why-is-preferable-to\">ссылке</a>.",
                "severity": 0
            },
